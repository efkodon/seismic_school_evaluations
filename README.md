...
Due to inconsistencies between data sources, full datasets that were not available publicly are not published with this project. Data excerpts can be found within the coding documents.